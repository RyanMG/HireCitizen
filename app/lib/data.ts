...
//     const numberOfInvoices = Number(query.rows[0].invoice_count ?? '0');
//     const numberOfCustomers = Number(query.rows[0].customer_count ?? '0');
//     const totalPaidInvoices = formatCurrency(query.rows[0].paid ?? '0');
//     const totalPendingInvoices = formatCurrency(query.rows[0].pending ?? '0');
